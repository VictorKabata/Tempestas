...
class ExtensionsTest {
    ...
    @Test
    fun `toReadableDateFormat returns correct date`() = runTest {
        val result = LocalDateTime.parse("2024-01-20T12:24:58")
        val expectedResult = "Saturday, 20 January 2024"

        assertEquals(expected = expectedResult, actual = result.toReadableDateFormat())
    }

    @Test
    fun `toReadableDateTimeFormat returns correct date`() = runTest {
        val result = LocalDateTime.parse("2024-01-20T12:24:58")
        val expectedResult = "20 January at 12:24"

        assertEquals(expected = expectedResult, actual = result.toReadableDateTimeFormat())
    }
